...
export const PROJECTS_DATA: Project[] = [
  ...
  duration: "2024 → 2026",
  tech: ["React 19", "Tailwind CSS v4", "TypeScript", "Vite", "pnpm"],
  status: "Deployed",
  description: "Migrazione da architettura legacy a sistema Production-Ready: React 19, Tailwind v4 native CSS-engine, zero dipendenze esterne.",
  fullDescription: "Il progetto nasce come coding test nel 2024 — replica pixel-perfect del sito originale completata in 7 giorni. Nel 2026 è diventato un laboratorio di refactoring integrale: migrazione a React 19 e Tailwind CSS v4 (native CSS-engine), eliminazione di ogni dipendenza superflua, implementazione di CSS Grid per azzerare il CLS, carosello prodotti basato su scroll nativo e sistema newsletter con gestione degli stati in tempo reale.",
  challenge: "Migrare un'architettura legacy a un sistema production-ready senza perdere la fedeltà pixel-perfect dell'interfaccia originale, eliminando al contempo ogni dipendenza esterna non necessaria.",
  solution: "Adozione di React 19 per ottimizzazioni di rendering e hook management. Migrazione a Tailwind CSS v4 con native CSS-engine per una riduzione del 30% del bundle CSS. Implementazione di CSS Grid per eliminare il Cumulative Layout Shift, caricamento adattivo delle immagini (eager Hero / lazy resto) e refactoring semantico completo con tag HTML5 per WCAG e SEO.",
  performance: "−30% CSS Bundle / Zero CLS",
  image: imgSoulfarm,
